...
const introduce = [
  ...
  },
  {
    ...
    describe:
      'Với lượt đặt phòng đầu tiên, bạn có thể lựa chọn chào đón một khách có kinh nghiệm, đã có ít nhất 3 kỳ ở và lịch sử hoạt động tốt trên CultureStay. Hãy tạo phòng ngay.',
  },
  {
    title: 'Hỗ trợ đặc biệt từ CultureStay và đăng ký dễ dàng với CultureStay Setup',
    describe:
